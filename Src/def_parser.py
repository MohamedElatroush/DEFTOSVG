...
#printing the file with the common def format 
    def to_def_format(self): #generating the def file "printing the head first which is common words in all the defs"
        s = ""
